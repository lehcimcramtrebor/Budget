...
async function generate() {
    ...
    // 4. Update ic_launcher_background.xml to set background to dark indigo #020617
    ...
    if (fs.existsSync(colorsXmlPath)) {
        ...
        if (colorsXml.includes('<color name="ic_launcher_background">')) {
            ...
            console.log('Updated ic_launcher_background.xml for adaptive background: #020617');
        } else {
